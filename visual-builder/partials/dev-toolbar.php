    ...
    <div class="topbar-nav">
        ...
        <nav id="main-menu">
            <ul>
                ...
                <li class="menu-export"><a data-tooltip="<?php esc_html_e('Export / Import', 'mfn-opts'); ?> <?php echo ($this->view == 'demo' ? '(Unavailable in Demo)' : ''); ?>" data-position="bottom" href="#"><?php esc_html_e('Export / Import', 'mfn-opts'); ?></a></li>
