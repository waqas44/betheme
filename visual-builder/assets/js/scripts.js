...
var elements = {
    wrap: function(size) {
        ...
        if( builder_type == 'header' ) {
            ...
            new_wrap.attr['css_advanced_align_items_laptop'] = {val: 'center', css_path: '.mcb-section .mcb-wrap-mfnuidelement .mcb-wrap-inner', css_style: 'align-items'};
            new_wrap.attr['css_advanced_align_items_tablet'] = {val: 'center', css_path: '.mcb-section .mcb-wrap-mfnuidelement .mcb-wrap-inner', css_style: 'align-items'};
            new_wrap.attr['css_advanced_align_items_mobile'] = {val: 'center', css_path: '.mcb-section .mcb-wrap-mfnuidelement .mcb-wrap-inner', css_style: 'align-items'};
        }
    ...
    section: function() {
        ...
        if( builder_type == 'header' ){
            ...
            new_section.attr['css_advanced_align_items_laptop'] = {val: 'center', css_path: '.mcb-section-mfnuidelement .section_wrapper', css_style: 'align-items'};
            new_section.attr['css_advanced_align_items_tablet'] = {val: 'center', css_path: '.mcb-section-mfnuidelement .section_wrapper', css_style: 'align-items'};
            new_section.attr['css_advanced_align_items_mobile'] = {val: 'center', css_path: '.mcb-section-mfnuidelement .section_wrapper', css_style: 'align-items'};
        }
    ...
    item: function(name, alias) {
        ...
        if( builder_type == 'header' ) {
            ...
            if( name == 'header_logo' || name == 'image' ){
                ...
                new_item.attr['css_advanced_flex'] = {val: '250px', css_path: '.mcb-section .mcb-wrap .mcb-item-mfnuidelement', css_style: 'flex'};
                be_layout.drag_new.force_rerender = true;
            }

            if( name == 'header_search' ){
                new_item.attr['width_switcher'] = 'custom';
                new_item.attr['css_advanced_flex'] = {val: '300px', css_path: '.mcb-section .mcb-wrap .mcb-item-mfnuidelement', css_style: 'flex'};
            }
...
function getFieldChange($field){
    ...
    if ( $editrow.closest('.transform_field').length ){
        ...
        if( typeof $field.attr('data-key') !== 'undefined' ){
            ...
            if( typeof editedd_item['attr'][id]['val'] === 'undefined' || typeof editedd_item['attr'][id]['val'] != 'object' ) editedd_item['attr'][id]['val'] = {};
    ...
    if( typeof $editrow.attr('data-oldid') !== 'undefined' && _.has(editedd_item['attr'], $editrow.attr('data-oldid')) && $editrow.hasClass('object-css-input') ) {
        ...
        if( $editrow.attr('data-oldid') == 'style:.mcb-section .mcb-wrap .mcb-item-mfnuidelement:flex' && _.has(editedd_item['attr'], 'style:.mcb-section .mcb-wrap .mcb-item-mfnuidelement:max-width') ) delete(editedd_item['attr']['style:.mcb-section .mcb-wrap .mcb-item-mfnuidelement:max-width']);
        if( $editrow.attr('data-oldid') == 'style:.mcb-section .mcb-wrap .mcb-item-mfnuidelement:flex_laptop' && _.has(editedd_item['attr'], 'style:.mcb-section .mcb-wrap .mcb-item-mfnuidelement:max-width_laptop') ) delete(editedd_item['attr']['style:.mcb-section .mcb-wrap .mcb-item-mfnuidelement:max-width_laptop']);
        if( $editrow.attr('data-oldid') == 'style:.mcb-section .mcb-wrap .mcb-item-mfnuidelement:flex_tablet' && _.has(editedd_item['attr'], 'style:.mcb-section .mcb-wrap .mcb-item-mfnuidelement:max-width_tablet') ) delete(editedd_item['attr']['style:.mcb-section .mcb-wrap .mcb-item-mfnuidelement:max-width_tablet']);
        if( $editrow.attr('data-oldid') == 'style:.mcb-section .mcb-wrap .mcb-item-mfnuidelement:flex_mobile' && _.has(editedd_item['attr'], 'style:.mcb-section .mcb-wrap .mcb-item-mfnuidelement:max-width_mobile') ) delete(editedd_item['attr']['style:.mcb-section .mcb-wrap .mcb-item-mfnuidelement:max-width_mobile']);
