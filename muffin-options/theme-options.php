...
if( ! function_exists( 'mfna_all_posts' ) ) {
	...
	function mfna_posts_list($search) {
		global $wpdb;
...
/*
				array(
					'id' => 'button-preset',
					'attr_id' => 'button-preset',
					'type' => 'radio_img',
					'title' => __('Import preset', 'mfn-opts'),
					'options' => array(
		...
		$sections['advanced'] = array(
			...
			'fields' => array(
				...
				array(
					...
					'type' => 'switch',
					'title' => __('Automatic theme updates', 'mfn-opts'),
					'desc' => __('Deprecated. WordPress 6.2 do not allow auto updates for themes outsite wordpress.org', 'mfn-opts'),
					'options' => array(
						'0' => __('Disable', 'mfn-opts'),
						'1' => __('Enable', 'mfn-opts'),
					),
		...
		$sections['shop-list'] = array(
			...
			'fields'	=> array(
				...
				array(
					...
					'desc' => __( 'After changing this option please <a href="admin.php?page=be-tools" target="_blank">Regenerate Thumbnails</a> ', 'mfn-opts' ),
					'class' => 'narrow',
					'param' => 'number',
					'after' => 'px',
					'std' => 800,
