						...
						$output .= '<div class="post-desc">';
							...
							$output .= '<div class="post-title">';
								...
								if( get_post_format() == 'quote' ){
									...
									$output .= '<'. esc_attr($title_tag) .' class="entry-title" itemprop="headline"><a href="'. esc_url(get_permalink()) .'">'. wp_kses(get_the_title(), mfn_allowed_html()) .'</a></'. esc_attr($title_tag) .'>';
